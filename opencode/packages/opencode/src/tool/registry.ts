...
import { SubmitReportTool, SwapSampleTool } from "./hyperion"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const submitReportTool = yield* SubmitReportTool
    const swapSampleTool = yield* SwapSampleTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          plan: Tool.init(plan),
          submit_report: Tool.init(submitReportTool),
          swap_sample: Tool.init(swapSampleTool),
